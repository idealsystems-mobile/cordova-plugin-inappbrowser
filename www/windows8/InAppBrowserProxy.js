...
var IAB = {
    ...
    open: function (win, lose, args) {
        var strUrl = args[0],
            ...
            features = args[2],
            url;
        Windows.UI.ViewManagement.InputPane.getForCurrentView().addEventListener("showing", showingKeyboard);
        Windows.UI.ViewManagement.InputPane.getForCurrentView().addEventListener("hiding", hidingKeyboard);
        if (target === "_system") {
